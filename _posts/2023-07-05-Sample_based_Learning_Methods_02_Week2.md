...
- Advantages of TD Prediction Methods
	...
	+ 예제 6.2 : Random Walk
		* 문제의 정의
			...
			![6_2_1_example_6_2_random_walk](/assets/images/posts/6_2_1_example_6_2_random_walk.png)
		...
		* TD(0) 와 constant-$\alpha$ MC 의 결과값
			...
			![6_2_2_example_6_2_random_walk_result](/assets/images/posts/6_2_2_example_6_2_random_walk_result.png)
...
- Optimality of TD(0)
	...
	+ 예제 6.3 : Random walk under batch updating
		...
		* 결과적으로 가치함수는 $v_\pi$ 와 비교되었으며, 다섯 개의 상태를 기준으로 한 평균 제곱근 오차를 계산하여 학습곡선을 얻기 위해 100번의 독립적인 실험을 반복적으로 수행하였다. ( 이 결과는 6.2 그림에 나타나 있음.)
		...
		![6_3_1_example_6_2_random_walk_batch_result](/assets/images/posts/6_3_1_example_6_2_random_walk_batch_result.png)
	...
	+ 예제 6.4 : You are the Predictor
		...
		* 다음 8개의 에피소드가 관찰되었다고 가정한다.
		...
		![6_3_2_example_6_3_you_are_the_predictor](/assets/images/posts/6_3_2_example_6_3_you_are_the_predictor.png)
...
- What is Temporal Difference (TD) learning?
	...
	+ Bootstrapping
		* value function 
			...
			![value_function_bootstrapping](/assets/images/posts/value_function_bootstrapping.png)
		
		* Temporal Difference
		
			![temporal_difference_bootstrapping](/assets/images/posts/temporal_difference_bootstrapping.png)
		
			- 위의 표기된 부분은 TD error 값임
		
		* DP 와의 차이점
		
			![difference_between_DP_and_TD](/assets/images/posts/difference_between_DP_and_TD.png)
	...
	+ 1-Step TD
		...
		* 1-Step TD
			...
			![1_step_TD](/assets/images/posts/1_step_TD.png)
		
		* TD(0) psuedo code
		
			![TD_0_psuedo_code](/assets/images/posts/TD_0_psuedo_code.png)
...
- The advantages of temporal difference learning
	...
	+ 예제 : Driving Home
		* 문제의 정의
			...
			- 이미 예전부터 많은 예측을 해왔었다.
		* 해석
			![td_example_driving_home_01](/assets/images/posts/td_example_driving_home_01.png)
			- 원 안의 값은 남은 운전시간에 대한 예측치이다.
			- 원가 원 사이의 값은 보상 값으로, 다음 단계까지의 실제 걸린 시간을 의미한다.
			- 하단의 시간은 실제 걸린 누적 시간을 의미한다.

			![td_example_driving_home_02](/assets/images/posts/td_example_driving_home_02.png)
			...
			![td_example_driving_home_03](/assets/images/posts/td_example_driving_home_03.png)
			- TD 의 경우
...
- Comparing TD and Monte Carlo
	...
	+ 예제 : Random Walk
		...
		![td_monte_carlo_compare_random_walk_01](/assets/images/posts/td_monte_carlo_compare_random_walk_01.png)
		...
		* 위의 설정 상, 결국 가치함수의 값은 해당 상태에서 우측으로 진행되어 종료될 확률과 같다.
		...
		![td_monte_carlo_compare_random_walk_02](/assets/images/posts/td_monte_carlo_compare_random_walk_02.png)

		* C, D, E 의 상태를 거쳐 우측에서 종료했을 경우
			- TD 에이전트의 경우 E 의 상태만 업데이트됨 (업데이트 식에서 그 이유를 알 수 있음)
			- 몬테카를로 에이전트의 경우 C, D, E 가 다 같이 업데이트됨.
		
		![td_monte_carlo_compare_random_walk_03](/assets/images/posts/td_monte_carlo_compare_random_walk_03.png)
		
		* 위 에피소드를 진행 후 두 번째 에피소드를 진행
			- TD 의 경우 매 스텝마다 값이 업데이트되나, 몬테카를로의 경우 Terminate 상태가 되지 않는 한 값이 업데이트되지 않는다.
		
		![td_monte_carlo_compare_random_walk_04](/assets/images/posts/td_monte_carlo_compare_random_walk_04.png)
		...
		* 위의 그래프는 TD 학습의 에피소드 학습 횟수별로 실제 값에 근사하는 모습을 보여줌 (constant-$\alpha$ = 0.1)
		...
		![td_monte_carlo_compare_random_walk_05](/assets/images/posts/td_monte_carlo_compare_random_walk_05.png)
